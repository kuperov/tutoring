...
\item \marginnote{\includegraphics[width=0.5\textwidth]{fig/56_coins.pdf}}
...
\item \marginnote{\includegraphics[width=0.5\textwidth]{fig/clock_0810.pdf}}
...
\item \marginnote{\includegraphics[width=0.5\textwidth]{fig/line_pencil_sharpenings.pdf}}
...
\item \marginnote{\includegraphics[width=0.5\textwidth]{fig/58_coins.pdf}}
How much money is there in total?\medskip
...
\item \marginnote{\includegraphics[width=0.5\textwidth]{fig/line_outside_play.pdf}}
...
\item \marginnote{\includegraphics[width=0.5\textwidth]{fig/clock_0110.pdf}}
The time is \dotfill\medskip\par\dotfill\medskip.
...
\item \marginnote{\includegraphics[width=0.5\textwidth]{fig/clock_0445.pdf}}
...
\marginnote{\includegraphics[width=0.5\textwidth]{fig/pvps_enrolments_grade_2024.pdf}}

Answer: About \dotfill\bigskip students were in\par \dotfill\bigskip.\par

\end{enumerate}

\clearpage\section{Problem set \textnumero 64}

\begin{enumerate}

\item \marginnote{\includegraphics[width=0.5\textwidth]{fig/clock_1155.pdf}}
The time is \dotfill\bigskip\par\dotfill\bigskip.\par
...
\item \marginnote{\includegraphics[width=0.5\textwidth]{fig/64_coins.pdf}}
...
\clearpage\section{Problem set \textnumero 65}
...
\item A wizard named Zorp had six hundred and seventy-two bottles of rainbow-flavored soda. 
He accidentally made another two hundred and twenty-nine bottles when he sneezed into his cauldron. 
How many bottles of soda does Zorp have now?\medskip\par
Number sentence: \dotfill\medskip\par
Answer: Zorp now has 
\dotfill\medskip\par\mbox{}\dotfill\medskip\par\mbox{}\dotfill\bigskip
 bottles of rainbow-flavored soda.

\item Some of the trees in the forest are oak trees. Every oak tree has acorns. If I find a tree with acorns, is it definitely an oak tree?\bigskip\par
Answer: \dotfill\bigskip


\item David received a party bag at his friend's birthday party. He made a table of its contents.
 \marginnote{
 \begin{tabular}{lc}
  \toprule 
  \textbf{Type of item} & \textbf{Quantity}\tabularnewline
  \midrule
  {Lollipops} & 2\tabularnewline
  {Wind-up toys} & 1\tabularnewline
  {Sugar lollies} & 3\tabularnewline
  {Balloons} & 3\tabularnewline
  {Chocolate frogs} & 2\tabularnewline
  \bottomrule
  \end{tabular}  
}
How many sweets did David receive?\bigskip\par
Answer: \dotfill\bigskip\par\dotfill\bigskip

\end{enumerate}

\clearpage\section{Problem set \textnumero 66}
...
\item \marginnote{\begin{tabular}{|c|c|c|c|}
  \hline 
  Name & Red & Blue & Green\tabularnewline
  \hline 
  \hline 
  Alex &  &  & \tabularnewline
  \hline 
  ...
  \hline 
  \end{tabular}}
Three friends, Alex, Ben, and Chloe, each have a favorite colour: red,
blue, or green. Use the clues to figure out who likes which colour.
\begin{itemize}
\item \textbf{Clue 1}: Alex's favourite colour is not green.
\item \textbf{Clue 2}: Ben loves the colour of the sky on a sunny day.
\item \textbf{Clue 3}: Chloe does not like the colour red.
\end{itemize}

Answer:
\begin{itemize}
\item Alex likes the colour \dotfill\bigskip.
\item Ben likes the colour \dotfill\bigskip.
\item Chloe likes the colour \dotfill\bigskip.
\end{itemize}

\end{enumerate}

\clearpage\section{Problem set \textnumero 67}
...
\item % Preview source code from paragraph 0 to 4
...
\clearpage\section{Problem set \textnumero 68}
...
\clearpage\section{Problem set \textnumero 69}
...
\clearpage\section{Problem set \textnumero 70}
...
The only clue is a note left on the counter.

\begin{itemize}
  \item \textbf{Clue 1}: The person who took the most cookies is not Kevin.
  \item \textbf{Clue 2}: Leo is allergic to milk.
  \item \textbf{Clue 3}: The person who took the fewest cookies also took milk.
  \item \textbf{Clue 4}: Daisy dislikes orange juice, and always eats an odd number of cookies.
\end{itemize}
